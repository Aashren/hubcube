...
<h1 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction"><span>Introduction</span></a></h1>
<hr>
<br>
<br>
<br>
<h2 id="_1-1-introduction" tabindex="-1"><a class="header-anchor" href="#_1-1-introduction"><span>1.1 Introduction</span></a></h2>
<p>In this document, we will briefly discuss about the history of satellites. We will also familirize
...
Nepali community.</p>
<br>
<h2 id="_1-2-history-of-satellite" tabindex="-1"><a class="header-anchor" href="#_1-2-history-of-satellite"><span>1.2 History of Satellite</span></a></h2>
<br>
<p>The history of satellites dates back to the late 1940s and early 1950s, when the Soviet Union
...
decision-making in various sectors.</p>
<p>      Satellites can come in different shapes, sizes and also weight. Based on their dimensions
...
the subset of small satellites.</p>
<br>
<h2 id="_1-3-cubesats" tabindex="-1"><a class="header-anchor" href="#_1-3-cubesats"><span>1.3 CubeSats</span></a></h2>
<br>
<p>A CubeSat is a type of small satellite for space research that usually has a volume of exactly
...
them suitable for a wide range of applications.</p>
<p>      CubeSats are used for a variety of missions, such as Earth observation, technology
...
platforms for future missions.</p>
<p>      When it comes to the CubeSats system, it can be divided into two main categories:
...
(IoT), providing connectivity and data transmission capabilities to remote areas of the planet.</p>
<br>
<h3 id="_1-3-1-features-and-advantages" tabindex="-1"><a class="header-anchor" href="#_1-3-1-features-and-advantages"><span>1.3.1 Features and Advantages</span></a></h3>
<br>
<br>
...
<br>
<p>As shown in Figure 1.1, the past 10 years has seen growth in the number in CubeSats. Initially
...
COTS.</p>
<p>      Most of the CubeSats missions are considered to have lower risk than the conventional
...
lower than the capital required for the manufacture of a conventional satellite ([3]).</p>
<p>      There has been instances when CubeSats have provided a significant path for advancing
...
compared to the former which was a 3U CubeSat ([4]).</p>
<br>
<br>
...
<p>      CubeSats can play a greater role in continuous monitoring of global geophysical processes
...
provides the freedom to be more dynamic with the technology that is available.</p>
<h3 id="_1-3-2-restrictions" tabindex="-1"><a class="header-anchor" href="#_1-3-2-restrictions"><span>1.3.2 Restrictions</span></a></h3>
<p>As the advantages of CubeSats have been many, there has been some issues as well. The most
...
4 CubeSats as their secondary payloads.</p>
<br>
<br>
<div style="text-align: center;">
...
<br>
<p>The propulsion systems are also seen to be difficult to have on a CubeSat because of the cost, size, mass constraints and also the administrative
...
deployed and the number is significantly higher than the conventional satellites ([3]).</p>
<br>
<h2 id="_1-4-antarikchya-pratisthan-nepal" tabindex="-1"><a class="header-anchor" href="#_1-4-antarikchya-pratisthan-nepal"><span>1.4 Antarikchya Pratisthan Nepal</span></a></h2>
<br>
<p>Antarikchya Pratisthan Nepal (APN) is a non-profit organization that aims to develop the space industry and promote space education in Nepal.</p>
<p>2015's earthquake in Nepal showed that the country needed before/after images and alternative mediums of communication. NepaliSat-1, led by Dr. Abhas Maskey, took the first step towards disaster mitigation by testing a self-built camera and communication module in space. Shortly after, Antarikchya Pratisthan Nepal was established. Since then, APN has been working to train the next generation of space leaders, tinkers, and designers to use the tools from space to solve problems on Earth while we simultaneously, focus on educating the general masses on space technology and its relevance to society.</p>
<p>Noteworthy is APN’s work in projects such as Munal, Nepal’s First High-School Cube Sat built and developed in-house; NEXT_GEN_CUBUS, a next-generation Satellite Bus system for CubeSat; PHI Project; Slippers2Sat, an ongoing middle-school CubeSat project including students from marginalized Chepang community; and many more. APN has also jointly collaborated and developed A Space Systems Laboratory at KUHS for the MUNAL Satellite. To inspire broader groups, APN has also developed outreach kits such as SastoCube, an educational non-flight satellite incorporating a complete end-to-end system of an entire CubeSat ecosystem; PaperSat, an innovative initiative designed for children of age 5+ to construct a satellite model using paper and plastic parts, and The Young Satellite Book; a children’s book inspired by Nepali Sat- 1.</p>
<p>Antarikchya Pratisthan Nepal aims to launch Nepal’s first astronaut by 2050. This vision of ours is quoted as “Vision 2050”. As Antarikchya Pratisthan Nepal continues to direct towards the organization’s ambitious goals, the organization also looks out for collaboration and partnerships as we believe forging alliances with international space agencies, research institutions, and industry partners can allow us to leverage expertise, resources, and opportunities to accelerate progress towards its objectives. Through collaboration, APN seeks to access cutting-edge technologies, exchange best practices, and amplify its impact on the global stage.</p>
<br>
<h3 id="_1-4-1-vision-2050" tabindex="-1"><a class="header-anchor" href="#_1-4-1-vision-2050"><span>1.4.1 Vision 2050</span></a></h3>
<br>
<p>Antarikchya Pratisthan Nepal’s Vision 2050 revolves around a milestone aiming to launch Nepal’s first astronaut by 2050. This ambitious vision represents a profound leap forward for Nepal, signifying its entry into the global arena of space exploration. At the heart of this endeavor lies a commitment to fostering innovation, scientific advancement, and national pride. Through a multifaceted approach encompassing boot camps, training programs, and outreach activities, APN is dedicated to empowering present and future generations of tinkerers, innovators, and engineers to achieve Vision 2050.</p>
<p>The vision of launching the first Nepalese astronaut by 2050 serves as a powerful symbol of national pride and achievement. It represents a tangible manifestation of Nepal’s commitment to pushing the boundaries of human knowledge and exploration. By embarking on this historic journey, Nepal not only elevates its status on the global stage but also inspires future generations to dream big and reach for the stars.</p>
<p>As Antarikchya Pratisthan Nepal continues to chart its course toward this ambitious goal, the organization also looks out for collaboration and partnerships as we believe forging alliances with international space agencies, research institutions, and industry partners can allow us to leverage expertise, resources, and opportunities to accelerate progress towards its objectives. Through collaboration, APN seeks to access cutting-edge technologies, exchange best practices, and amplify its impact on the global stage.</p>
<p>The Vision 2050 focusing on marking a historic milestone in the nation’s journey also comprises of focused initiatives in education, training, and outreach through which the groundwork is being laid for a future where Nepalese astronauts boldly venture into the final frontier.</p>
</div>
</div></template>
