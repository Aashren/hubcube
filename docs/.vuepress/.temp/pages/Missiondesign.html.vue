...
<h1 id="mission-design" tabindex="-1"><a class="header-anchor" href="#mission-design"><span>Mission Design</span></a></h1>
<hr>
<head>
...
<br>
<p>In chapter 1 we discussed about CubeSats and it’s benifits and also it’s restriction. In this
...
phase of the satellite.</p>
<p>      Apart from technical limitations and budgetary limitations, there can also be a social
...
has to be aware before making a satellite.</p>
<br>
<h2 id="_2-2-bus-systems" tabindex="-1"><a class="header-anchor" href="#_2-2-bus-systems"><span>2.2 Bus Systems</span></a></h2>
<br>
<p>The bus system in a CubeSat refers to the various subsystems and components that make
...
CubeSat to perform its intended mission.</p>
<p>      It is important to understand the difference between the bus system and the subsystems.
...
the subsystems.</p>
<p>     The importance of a well-designed bus system in a CubeSat includes:</p>
  <ul>
...
<p>     A well-designed bus system can help to ensure the CubeSat is reliable and performs as
...
the entire system.</p>
<p>     In summary, the bus system of a CubeSat plays a crucial role in the satellite’s overall design
...
<br></p>
<h2 id="_2-3-subsystems" tabindex="-1"><a class="header-anchor" href="#_2-3-subsystems"><span>2.3 Subsystems</span></a></h2>
<br>
<p>     Subsystems of a satellite generally refers to the various functional components or modules that
...
command and data handling, structure, propulsion, and payload.</p>
<p>     Understanding and managing the interactions and interfaces between these subsystems
...
operation and mission success.</p>
<p>    A satellite is made up of several subsystems, and they are listed below:</p>
<ul>
<li>Electrical Power System (EPS)</li>
<li>Structure System</li>
<li>Communication System</li>
<li>ADCS</li>
<li>OBC System</li>
<li>Thermal System</li>
<li>Payload System
<br></li>
</ul>
<h3 id="_2-3-1-electric-power-system" tabindex="-1"><a class="header-anchor" href="#_2-3-1-electric-power-system"><span>2.3.1 Electric Power System</span></a></h3>
  <br>
<p>The EPS is a crucial subsystem for the proper functioning of a CubeSat. It is responsible
...
the satellite, and protecting it and its subsystems from the high levels of radiation in space.</p>
<p>Below we discuss about the most important of EPS:</p>
<ul>
<li>
<p><b>Power Sources:</b>The primary source of power for a CubeSat’s EPS is energy collected
...
on-board the CubeSat.</p>
</li>
<li>
<p><b>Power Control and Distribution: </b>The EPS is responsible for regulating and distributing the power collected and stored by the solar panels and batteries to other systems
...
batteries into the appropriate voltage levels for different systems and sensors.</p>
</li>
<li>
<p><b>Monitoring and Protection: </b>The EPS also plays an important role in monitoring the
...
protect the CubeSat and its subsystems from these events.</p>
</li>
</ul>
<p><b> Electrical Requirements</b></p>
<p>In order to ensure the safety of the CubeSat during launch and operation, there are certain
electrical requirements that are recommended for the standard CubeSat form factor that EPS
should adhere to. These include:</p>
<ul>
<li>
<p>No electronics may be active during launch to prevent any electrical or RF interference
with the launch vehicle and primary payloads. CubeSats with rechargeable batteries
must be fully deactivated during launch or launch with discharged batteries.</p>
</li>
<li>
<p>One deployment switch is required (two are recommended) for each CubeSat. The
deployment switch should be located at designated points.</p>
</li>
<li>
<p>Developers who wish to perform testing and battery charging after integration must provide ground support equipment (GSE) that connects to the CubeSat through designated
data ports.</p>
</li>
<li>
<p>A remove before flight (RBF) pin is required to deactivate the CubeSats during integration outside the Poly-PicoSatellite Orbital Deployer (P-POD). The pin will be removed
once the CubeSats are placed inside the P-POD. RBF pins must fit within the designated
data ports without protruding more than 6.5 mm from the rails when fully inserted.</p>
</li>
<li>
<p>A remove before flight (RBF) pin is required to deactivate the CubeSats during integration outside the Poly-PicoSatellite Orbital Deployer (P-POD). The pin will be removed
once the CubeSats are placed inside the P-POD. RBF pins must fit within the designated
...
<p>     In conclusion, the EPS is a crucial subsystem for the proper functioning of a CubeSat. It is
...
and maximize energy efficiency to extend the CubeSat’s lifespan in orbit.</p>
<br>
<h3 id="_2-3-2-structure-system" tabindex="-1"><a class="header-anchor" href="#_2-3-2-structure-system"><span>2.3.2 Structure System</span></a></h3>
<br>
<p>A structure sub-system in a cubesat refers to the physical framework of the satellite, which
...
subsystems and enables the satellite to maintain its shape and integrity in space.</p>
<p>    In humans, the structural system is made up of the body itself, including the skeleton,
...
operation.</p>
<p>    The structural subsystem is critical for maintaining the structural integrity of the satellite
...
essential for the safe and successful operation of a satellite in space.</p>
<p>    Unlike conventional satellites, while designing a CubeSat structure system, we have to keep
...
one must also pay attention to these key aspects that are listed and briefly explained below:</p>
<ul>
<li>
<p><b>CubeSat Structure:</b> The structure of a CubeSat typically consists of an aluminum or
...
adequate structural integrity during launch and in space.</p>
</li>
<li>
<p><b>Panels and Rails</b> CubeSat structures often include removable panels and rails on the
...
points for subsystems, such as power systems, communication systems, and sensors.</p>
</li>
<li>
<p><b>Deployable Solar Panels:</b> Many CubeSats are equipped with deployable solar panels
...
to the onboard systems and recharge the batteries.</p>
</li>
<li>
<p><b>Antenna Deployment:</b> CubeSats require antennas for communication purposes. The
...
<li>
<p><b>Vibration and Shock Mitigation</b> CubeSats must withstand the vibrations and shocks
...
protect the CubeSat’s sensitive subsystems and payloads from damage.</p>
</li>
<li>
<p><b>Integration and Testing:</b> CubeSat structure systems undergo rigorous integration and
...
to validate the structure’s performance under expected environmental conditions.</p>
</li>
<li>
<p><b>Standardized Mechanical Interfaces:</b> CubeSats use standardized mechanical interfaces,
...
CubeSat into its designated orbit.</p>
</li>
</ul>
<p>While designing the CubeSat structure, one must thus be aware of the SWaP requirements and also the launcher requirements. Generally, the structures provide are lightweight, reliable and compact platform to conduct a successful mission with the resources in hand. The standards for CubeSats help in the due process of designing a satellite.</p>
<br>
<h3 id="_2-3-3-communication-systems" tabindex="-1"><a class="header-anchor" href="#_2-3-3-communication-systems"><span>2.3.3 Communication Systems</span></a></h3>
<br>
<p>The communication system is responsible for transmitting and receiving data from the Cube-
...
design considerations, and best practices.</p>
<p>The role of the communication subsystem is to facilitate communication between the
...
camera, and then transmitting the picture back to the ground station for analysis.</p>
<p>The communication subsystem must be able to transmit and receive data at the necessary
...
degrees Celsius and has a radiation tolerance of 50 krad.</p>
<p>The packet data communication protocol is responsible for ensuring the correct transmission
...
limited data storage capacity.</p>
<p>The data transmission speed between the ground station and the CubeSat is determined
...
software. It must also have a reliable power source and internet connection. Additionally, the ground station must be located in an area with a clear line of sight to the CubeSat’s orbit.</p>
<p><b>Antenna and Link Budgets</b></p>
<p>The design of the CubeSat antenna is a crucial aspect of the communication subsystem. The antenna must be able to transmit and receive signals at the necessary frequencies and with the required gain. Factors such as the CubeSat’s orbit, the size and weight constraints of the CubeSat, and the desired communication range must be taken into account when designing the antenna. For example, a CubeSat in a low Earth orbit may require a small, lightweight antenna with a lower gain, while a CubeSat in a higher orbit may require a larger, more powerful antenna with a higher gain.</p>
<p>Link budget is the calculation of the amount of power required at the transmitter and the sensitivity required at the receiver to establish a successful communication link. It includes factors such as the transmitter power, the receiver sensitivity, the path loss, and the atmospheric conditions. The link budget design is an important step in the communication subsystem design process, as it helps to ensure that the CubeSat will be able to communicate effectively with the ground station.</p>
<p>The communication method and frequency used by a CubeSat will depend on the mission requirements and the available communication equipment. Factors such as the desired data transmission rate, the CubeSat’s orbit, and the availability of frequencies must be taken into account when determining the communication method and frequency. An example of this would be a CubeSat in a low Earth orbit that uses UHF frequencies for communication, while a CubeSat in a higher orbit may use S-band or X-band frequencies.</p>
<p><b>Communication Standards</b></p>
<p>There are various communication standards that have been developed specifically for Cube- Sats, such as the CubeSat Space Protocol (CSP) and the CubeSat Communication Protocol (CCP). These standards provide guidelines for the design and operation of the communication subsystem and can help to ensure compatibility between different CubeSats and ground stations. Error correction and data compression are important techniques that can be used to improve the efficiency and reliability of the communication subsystem. Error correction techniques, such as forward error correction (FEC), can be used to detect and correct errors that may occur during data transmission. Data compression techniques, such as lossless or lossy compression, can be used to reduce the size of the data being transmitted, which can help to increase the data transmission speed.</p>
<p>Security is a critical aspect of the communication subsystem, as it ensures the integrity and
...
signatures, to ensure that the data is coming from a trusted source.</p>
<p>In conclusion, the communication subsystem in CubeSats plays a vital role in the successful
...
<br></p>
<h3 id="_2-3-4-adcs" tabindex="-1"><a class="header-anchor" href="#_2-3-4-adcs"><span>2.3.4 ADCS</span></a></h3>
<br>
<p>The ADCS is responsible for maintaining the CubeSat’s orientation in space and pointing
...
desired pointing directions or stability.</p>
<p>While designing a functional ADCS, a system that senses its position or attitude should be
...
now discuss the main components and also the functionalities of a ADCS :</p>
<ul>
<li>
<p><b>Sensors:</b> The attitude determination process relies on various sensors to measure the
CubeSat’s attitude parameters. These sensors may include:</p>
<ul>
<li><em>Gyroscopes or rate sensors</em>: To measure the angular velocity or rate of rotation of the CubeSat.</li>
<li><em>Magnetometers</em>: To measure the magnetic field to determine the satellite’s orientation with respect to the Earth’s magnetic field.</li>
<li><em>Sun sensors</em>: To detect the direction of sunlight to determine the CubeSat’s orientation relative to the Sun.</li>
<li><em>Inertial measurement units (IMUs)</em>: To combine multiple sensors, such as accelerometers, gyroscopes, and magnetometers, to provide comprehensive attitude measurements.</li>
</ul>
</li>
<li>
<p><b>Data Processing:</b> The ADCS processes the snsor data to calculate the CubeSat's attitude. This involves data fusion algorithms that combine the measuremenets from different sensors to obtain a more accurate and reliable estimate of the attitude. Various filtering techniques, such as Kalman filtering or complementary filtering, are commonly employed to optimize the attitude determination process.</p>
</li>
<li>
<p><b>Control Actuators:</b> The attitude control aspect of the ADCS utilizes actuators to adjust and maintain the CubeSat’s orientation. Commonly used actuators include:</p>
<ul>
<li><em>Reaction wheels</em>: These spinning wheels can change the satellite’s angular momentum by accelerating or decelerating their rotation. By controlling the angular momentum, the CubeSat’s orientation can be adjusted.</li>
<li><em>Magnetorquers</em>: These devices use electromagnetic forces generated by onboard electromagnets to interact with the Earth’s magnetic field. By selectively activating the magnetorquers, the CubeSat can generate torque and control its orientation.</li>
<li><em>Thrusters</em>: In some cases, CubeSats may be equipped with small thrusters that use compressed gas or electric propulsion to provide additional attitude control capabilities.</li>
</ul>
</li>
<li>
<p><b>Control Algorithms:</b> ADCS incorporates control algorithms to calculate the necessary actuator commands based on the desired attitude and the measured attitude. These algorithms aim to minimize the error between the desired attitude and the actual attitude, providing stable and accurate control</p>
</li>
<li>
<p><b>Power and Communication:</b> ADCS also requires power and communication links to operate. It is typically connected to the CubeSat's power supplu and onboard computer system for data processing and actuator control. The ADC system may also interface with the CubeSat's communication subsystem to receive commands and provide attitude-related telemetry data to the ground station.</p>
</li>
</ul>
<p>The ADCS plays a critical role in CubeSat missions that require precise pointing, imaging, or data acquisition. It enables the satellite to maintain a desired orientation, stabilize its attitude, or adjust its pointing direction for scientific observations, Earth imaging, or communication purposes.</p>
<br>
<h3 id="_2-3-5-obc-system" tabindex="-1"><a class="header-anchor" href="#_2-3-5-obc-system"><span>2.3.5 OBC System</span></a></h3>
<br>
<p>The OBC system is a crucial component of any CubeSat mission, serving as the central control
...
considered when designing an OBC for a 1U CubeSat.</p>
<p>In recent years, there has been a trend towards using more advanced and powerful OBCs
...
the reliability and performance of OBCs.</p>
<p>The hardware used in an OBC typically includes a microprocessor, memory banks, and
...
of microcontroller types.</p>
<p><b>Role of OBCs in CubeSats</b></p>
<p>The OBC plays several key roles in the effective operation of a CubeSat. These functions include:</p>
<ul>
<li>
<p><b>Attitude and Orbit control:</b> The OBC is responsible for controlling the attitude and
orbit of the CubeSat, ensuring that it stays within the desired parameters.</p>
</li>
<li>
<p><b>Telemtry data management:</b> The OBC is responsible for receiving, processing, and storing telemetry data from the CubeSat’s various subsystems, such as the power distribution system, the communication system, and the payload.</p>
</li>
<li>
<p><b>Telecommunication actions:</b> The OBC is responsible for managing the CubeSat’s communication systems, including sending and receiving telecommands and telemetry data
to and from the ground station.</p>
</li>
<li>
<p><b>System Housekeeping:</b> The OBC is responsible for monitoring the health and performance of the CubeSat’s subsystems and for performing any necessary housekeeping tasks, such as data backups and system updates.</p>
</li>
<li>
<p><b>On-board time synchronization:</b> The OBC is responsible for maintaining accurate timekeeping on the CubeSat, which is crucial for accurate orbit prediction and coordination
of activities.</p>
</li>
<li>
<p><b>Failure detection, isolation, and recovery:</b> The OBC is responsible for detecting and isolating any failures that occur on the CubeSat, and for initiating recovery procedures to bring the CubeSat back to normal operation.</p>
</li>
</ul>
<p><b>Requirements for Designing an OBC for a 1U CubeSat</b></p>
<p>When designing an OBC for a 1U CubeSat, several key requirements must be considered to
...
teams involved in the project, such as the mechanical, electrical, and software teams.</p>
<p>In addition, the OBC hardware and software should be thoroughly tested before launch
to ensure that it will work as intended in the space environment. This includes testing for
radiation tolerance, thermal cycling, vibration, and shock.These requirements include:</p>
<ul>
<li>
<p><b>Processing capability:</b> The OBC must have sufficient processing power to handle the
demands of the CubeSat’s payload and subsystems.</p>
</li>
<li>
<p><b>Memory:</b> The OBC must have enough memory to store the data generated by the
CubeSat’s payload and subsystems, as well as any housekeeping data.</p>
</li>
<li>
<p><b>Interoperability and interfacing capabilities:</b> The OBC must be able to interface effectively with the CubeSat’s other subsystems, such as the power distribution system and
the communication system.</p>
</li>
<li>
<p><b>Reliability of software:</b> The software running on the OBC must be reliable to ensure
that the CubeSat can operate effectively.</p>
</li>
<li>
<p><b>Power requirements:</b> The OBC must be able to operate within the power constraints of
the CubeSat.</p>
</li>
<li>
<p><b>Size and weight:</b> The OBC must be small and lightweight enough to fit within the 1U
CubeSat’s mass and volume constraints.</p>
</li>
<li>
<p><b>Radiation tolerance:</b> The OBC must be able to withstand the harsh radiation environment of space without suffering any damage or degradation in performance.</p>
</li>
<li>
<p><b>Single point of failure (SPOF):</b> The OBC should be designed in such a way that it is able to withstand a SPOF without compromising the overall functionality of the
CubeSat.</p>
</li>
<li>
<p><b>Thermal management:</b> The OBC must be able to operate within the CubeSat’s thermal
constraints, which can vary depending on the CubeSat’s orbit and orientation.</p>
</li>
<li>
<p><b>Power manangement:</b> The OBC must be able to effectively manage the power consump-
tion of the CubeSat’s subsystems, in order to ensure that the CubeSat can operate for
the duration of its mission.</p>
</li>
<li>
<p><b>Fault tolerance:</b> The OBC must be able to tolerate faults in the CubeSat’s subsystems
and continue to operate effectively.</p>
</li>
<li>
<p><b>Security:</b> The OBC must be designed with security in mind, to protect the CubeSat
against cyber-attacks and unauthorized access.</p>
</li>
</ul>
<br>
<h3 id="_2-3-6-thermal-system" tabindex="-1"><a class="header-anchor" href="#_2-3-6-thermal-system"><span>2.3.6 Thermal System</span></a></h3>
<br>
<p>The thermal subsystem in a CubeSat is responsible for managing and regulating the satellite’s
...
of the thermal subsystem in a CubeSat:</p>
<ul>
<li>
<p><b>Thermal Design:</b> The thermal design of a CubeSat involves determining the heat generation and dissipation characteristics of the onboard systems and components. It includes identifying the critical heat sources, such as electronic components, power systems, and payloads, and designing strategies to manage their thermal loads. Generally, thermal management is done with two different processes and they are discussed below:</p>
<ul>
<li>Passive Thermal Control: Passive thermal control techniques aim to regulate the satellite’s temperature without active components or power consumption. These techniques include:
<ul>
<li><em>Insulation</em>: The CubeSat structure is typically equipped with thermal insulation materials to minimize heat transfer between the internal and external environments Insulation helps maintain a stable temperature inside the satellite.</li>
<li><em>Radiative Surfaces</em>: The outer surfaces of the CubeSat structure are often designed with specific coatings or materials that enhance or reduce the emission and absorption of thermal radiation. This helps in managing the heat gain or loss from the satellite.</li>
</ul>
</li>
<li>Active Thermal Control: Active thermal control techniques involve the use of active components and mechanisms to actively manage the satellite’s temperature. These techniques include:
<ul>
<li><em>Heaters</em>: Heaters are used to generate controlled amounts of heat in specific areas of the CubeSat. They are employed to prevent components from getting too cold, remove condensation, or maintain optimal operating temperatures.</li>
<li><em>Heat Sinks and Heat Pipes</em>: Heat sinks made of thermally conductive materials, such as aluminum or copper, are used to absorb and dissipate heat from high-temperature components. Heat pipes, which are sealed copper pipes containing a working fluid, are also employed to efficiently transfer heat from one location to another within the CubeSat structure.</li>
<li><em>Temperature Sensors</em>: Temperature sensors are integrated into various locations inside the CubeSat to monitor the temperature of critical components. This information is used to regulate the active thermal control mechanisms and ensure that temperatures remain within acceptable limits.</li>
</ul>
</li>
</ul>
</li>
<li>
<p><b>Thermal Coatings:</b> Specialized coatings on the satellite’s surfaces can enhance or reduce
...
<li>
<p><b>Thermal Modeling and Analysis:</b> Thermal modeling and analysis are conducted to
...
optimize the thermal subsystem.</p>
</li>
<li>
<p><b>Testing and Verification:</b> The thermal subsystem undergoes rigorous testing to ensure
...
performance under extreme temperatures.</p>
</li>
</ul>
<p>The thermal subsystem The thermal subsystem is essential for maintaining the proper functioning and longevity
...
the overall mission success.</p>
<br>
<h3 id="_2-3-7-payload-system" tabindex="-1"><a class="header-anchor" href="#_2-3-7-payload-system"><span>2.3.7 Payload System</span></a></h3>
<br>
<p>The payload of a CubeSat refers to the scientific instruments or commercial equipment that
...
be followed while designing the payloads and the bus system to integrate them.</p>
<p>It’s important to understand the difference between the payload and the bus system.
...
with a well-designed bus system is essential for the successful operation of a CubeSat.</p>
<p><b>Types of Payloads</b></p>
<p>There are several types of payloads that can be integrated into a CubeSat, including:</p>
<ul>
<li>
<p><b>Scientific payloads:</b> These payloads are designed to perform specific scientific experiments or observations. Examples include: cameras for Earth observation, spectrometers for atmospheric studies, and magnetometers for space weather research.</p>
</li>
<li>
<p><b>Commerical payoads:</b> These payloads are designed for commercial applications, such
as remote sensing, telecommunications, and navigation. Examples include: high resolution cameras, radar systems, and GPS receivers.</p>
</li>
<li>
<p><b>Technology demonstration paylaods:</b> These payloads are designed to test and demonstrate new technologies in space. Examples include: advanced propulsion systems and
new materials.</p>
</li>
<li>
<p><b>Educaation and Outreach Payloads:</b> CubeSats provide a valuable opportunity for educational institutions and organizations to engage students and the public in space-related
activities. These CubeSats may carry payloads designed for educational purposes, such as cameras for capturing images, student-built experiments, or amateur radio equipment fDesign Requirementsor communication.</p>
</li>
</ul>
<p><b>Design Requirements</b></p>
<p>When designing the payloads and the bus system to integrate them, it is important to consider
several requirements, some of them are mentioned below:</p>
<p>Moving forward towards building a nanosatellite, we will be dealing with the design,
...
we will be able to get a detailed idea about the various components.</p>
<table>
   <tr>
      <td> Compatibility:</td>
...
<ul>
<li>
<p><b>Semi-major axis (a):</b> This element represents half the length of the longest diameter of
the elliptical orbit. It describes the size of the orbit and determines the average distance
between the satellite and the object it is orbiting.</p>
</li>
<li>
<p><b>Eccentricity (e):</b> Eccentricity measures the shape of the orbit. It tells us how elongated or
circular the orbit is. An eccentricity of 0 represents a perfect circle, while an eccentricity
closer to 1 represents a more elongated orbit.</p>
</li>
<li>
<p><b>Inclination (i):</b> Inclination is the angle between the orbital plane of the satellite and a
reference plane, usually the equatorial plane of the object being orbited. It determines how tilted the orbit is with respect to the reference plane.</p>
</li>
<li>
<p><b>Right Ascension of the Ascending Node (Ω):</b> This element represents the angle
...
orbital plane in space.</p>
</li>
<li>
<p><b>Argument of Perigee ( ω )</b> The argument of perigee is the angle between the ascending
node and the point of closest approach to the central object, called the perigee. It defines
the orientation of the satellite within its orbit.</p>
</li>
<li>
<p><b>Mean Anomaly (M):</b> The mean anomaly represents the angular position of the satellite
along its orbit at a specific point in time. It helps determine the satellite’s position
within its orbit based on time.</p>
</li>
</ul>
<p>By combining these elements, we can precisely define the shape, size, and orientation of
...
<br></p>
<h2 id="_2-5-testing-and-analysis" tabindex="-1"><a class="header-anchor" href="#_2-5-testing-and-analysis"><span>2.5 Testing and Analysis</span></a></h2>
<br>
<p>Testing and analysis are critical for ensuring that a CubeSat structure will withstand the
...
required for a 1U CubeSat structure, including:</p>
<ul>
<li><b>Structural testing:</b> This type of testing is used to verify the structural integrity of
...
vibration, and shock.</li>
<li><b>Fatigue testing:</b> This type of testing is used to verify that the CubeSat structure can
withstand the repeated loads and vibrations it will experience during its lifetime.</li>
<li><b>Thermal testing:</b> This type of testing is used to verify the thermal performance of the
CubeSat structure and its ability to survive the extreme temperatures of space. This
includes testing for solar radiation, conduction, and convection.</li>
<li><b>Material testing:</b> This type of testing is used to verify that the materials used in
the CubeSat structure meet the required mechanical and thermal properties and can
withstand the space environment.</li>
<li><b>Environmental testing:</b> This type of testing is used to verify that the CubeSat structure
can withstand the harsh environment of space, including vacuum, radiation, and
extreme temperatures.</li>
<li><b>Finite Element Analysis (FEA)</b> This type of analysis is used to simulate the loads,
...
failure points.</li>
<li><b>Computational Fluid Dynamics (CFD)</b> This type of analysis is used to simulate the
thermal and fluid flow characteristics of the CubeSat structure. This allows for opti-
mization of the thermal design and identification of potential thermal failure points.</li>
</ul>
<p>It’s important to note that the CubeSat structure should be designed in a way that allows
...
taken into account when designing a 1U CubeSat structure. These include:</p>
<ul>
<li>
<p><em>Design margins</em>: The structure should be designed with adequate margins to ensure
that it can withstand the loads and environments it will experience during launch and
on-orbit operations.</p>
</li>
<li>
<p><em>Electromagnetic Interference (EMI)/ Electromagnetic Compatibility (EMC)</em>: The structure
should be designed to minimize EMI and EMC issues, which can affect the performance
of electronic subsystems.</p>
</li>
<li>
<p><em>Outgassing</em>: The structure should be designed to minimize outgassing, which can
contaminate other spacecraft and instruments.</p>
</li>
<li>
<p><em>Mass and volume constraints</em>: The structure should be designed to be as lightweight
and compact as possible, to maximize the available volume for other subsystems and
payloads.</p>
</li>
<li>
<p><em>Compatibility with launch vehicles and dispensers</em>: The structure should be designed to be
compatible with the launch vehicle and dispenser that will be used for launch.</p>
</li>
<li>
<p><em>Cost</em>: The structure should be designed to minimize costs, while still meeting all of the
requirements for the mission.</p>
</li>
<li>
<p><em>Durability</em>: The structure should be designed to withstand the harsh environment of
space and last for the duration of the mission, taking into account the factors such as
radiation, thermal and mechanical loads.</p>
</li>
<li>
<p><em>Space debris</em>: The structure should be designed to minimize the risk of creating space
debris, by ensuring that all parts remain attached to the CubeSat during launch, ejection
and operation.</p>
</li>
<li>
<p><em>Standardization</em>: The structure should be designed to be compliant with relevant stan-
...
<p>Overall, designing a 1U CubeSat structure requires a balance between competing require-
...
<br></p>
<h2 id="_2-6-recommendations" tabindex="-1"><a class="header-anchor" href="#_2-6-recommendations"><span>2.6 Recommendations</span></a></h2>
<br>
<p>Most of satellite mission designers and engineers follow the quote by William of Ockham
...
expect from the mission and how to accomplish it.</p>
<p>The objective of the mission should be known and all the subsystems must be designed
...
mission design.</p>
<p>While designing the orbit, one also has to be aware of the launcher requirements and work
